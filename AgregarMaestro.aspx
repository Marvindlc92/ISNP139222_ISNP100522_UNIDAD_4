<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AgregarMaestro.aspx.vb" Inherits="ISNP139222_ISNP100522_UNIDAD_4.AgregarMaestro" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table align="center" style="width: 80%; border-style: solid; border-width: 1px; background-color: #E4B9B9">
        <tr>
            <td class="text-center" colspan="2"><strong>AGREGAR DOCENTES</strong></td>
        </tr>
        <tr>
